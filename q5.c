...
struct sockaddr saddr; 		 	
    ...
    */
    ...
    {
        int j;
        unsigned char u = (sock_raw , SOL_SOCKET , SO_BINDTODEVICE , "wlan%c", j, strlen(("wlan%c", j))+ 1 );
        unsigned char v = (sock_raw , SOL_SOCKET , SO_BINDTODEVICE , "eno%c", j, strlen(("eno%c", j))+ 1 );
        unsigned char w = (sock_raw , SOL_SOCKET , SO_BINDTODEVICE , "enp%cs*", j, strlen(("enp%cs*", j))+ 1 );
        unsigned char x = (sock_raw , SOL_SOCKET , SO_BINDTODEVICE , "eth%c", j, strlen(("eth%c", j))+ 1 );
        unsigned char y = (sock_raw , SOL_SOCKET , SO_BINDTODEVICE , "wlo%c", j, strlen(("wlo%c", j))+ 1 );
        unsigned char z = (sock_raw , SOL_SOCKET , SO_BINDTODEVICE , "vnet%c", j, strlen(("vnet%c", j))+ 1 );
